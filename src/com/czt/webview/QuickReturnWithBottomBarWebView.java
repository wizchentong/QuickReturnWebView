...
public class QuickReturnWithBottomBarWebView  extends TitleBarWebView {
	...
	public QuickReturnWithBottomBarWebView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public QuickReturnWithBottomBarWebView(Context context, AttributeSet attrs, int defStyle) {
